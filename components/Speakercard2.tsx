        ...
        <div className="relative bg-neutral-900/50 border border-white/5 hover:border-red-600/30 transition-colors duration-500 h-full flex flex-col">
          ...
          <div className="relative aspect-[4/5] overflow-hidden w-full">
            ...
            <div className="absolute top-0 right-0 p-4 z-20">
              <DiagonalSlice
                variant="outline"
                className="w-12 h-12 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              />
            </div>
          ...
          <div className="p-6 flex flex-col flex-grow relative">
            <div className="absolute top-0 right-6 w-[2px] h-8 bg-red-600/50 transform origin-top scale-y-0 group-hover:scale-y-100 transition-transform duration-500 delay-200" />
            ...
            <div className="mb-4 relative">
              <Triangle
                direction="left"
                size="sm"
                className="absolute -left-3 top-2 w-2 h-2 text-red-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              />
              <h3 className="text-2xl font-bold text-white mb-1 group-hover:text-red-500 transition-colors pl-2">
                {speaker.name}
              </h3>
              <p className="text-red-600 text-xs font-bold tracking-widest uppercase pl-2">
                {speaker.title}
              </p>
            </div>
