...
const DEFAULT_IMAGES: ImageItem[] = galleryImages;
...
export default function DomeGallery({
  ...
  const activeSegments = isMobile
    ? Math.max(10, Math.floor(segments / 2))
    : segments;
  ...
  const items = useMemo(
    () => buildItems(images, activeSegments),
    [images, activeSegments]
  );
