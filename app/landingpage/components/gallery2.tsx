...
export default function Gallery2() {
  ...
  return (
    <div className="bg-transparent pb-24 text-white relative">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-8">
