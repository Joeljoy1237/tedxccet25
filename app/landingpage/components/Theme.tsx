...
export default function Theme() {
  return (
    <section className="py-14 px-6 bg-black text-white relative flex flex-col items-center justify-center text-center ">
      ...
      {/* Main Title  DAUNTØ*/}
      <h2 className="text-5xl md:text-7xl font-bold mb-12 font-robofan text-[#EB0028] tracking-wider">
        DAUNT
      ...
      {/* Content */}
      <div className="max-w-screen mx-[3vw] space-y-8 text-lg md:text-xl text-neutral-300 leading-relaxed font-light md:text-justify">
        <p>
